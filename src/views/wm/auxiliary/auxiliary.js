...
import {getList,save,remove,getall,excelImport,GetPagedAsyncByExport,confirmExcelImport} from '@/api/wm/auxiliary'
...
export default {
    ...
    methods: {
        ...
        exportTemplateExcel() {
            ...
            const data = [];
            //console.log( this.formatDateTimeNow())
            const filename = '辅料导入模板' + this.formatDateTimeNow();
