...
import { remove, getList, save, GetItem } from '@/api/basicData/itemproduct'
import { regionDataPlus, CodeToText, TextToCode } from 'element-china-area-data'
import { getall as getCluesAll } from '@/api/basicData/itemproduct'
...
export default {
  ...
  methods: {
    ...
    fetchData() {
      console.log(this.listQuery.createDept, "this.createDept");
    ...
    edit(row) {
      ...
      if (this.checkSel()) {
        ...
        this.formVisible = true
        if (row.addressDetails != null) {
          var str = row.addressDetails.split("-");
