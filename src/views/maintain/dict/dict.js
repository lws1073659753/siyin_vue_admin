  ...
  methods: {
    ...
    save() {
      ...
      this.$refs['form'].validate((valid) => {
        if (valid) {
          ...
          save({ id: id, name: name,description:this.form.description, children: dictValues }).then(response => {
            this.$message({
              message: '提交成功',
              type: 'success'
            })
    ...
    edit() {
      if (this.checkSel()) {
        ...
        this.form = { name: this.selRow.name, id: this.selRow.id,description: this.selRow.description, details: details, children: children }
        this.formVisible = true
      }
    },
    removeItem(record) {
