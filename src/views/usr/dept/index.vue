  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="操作">
        <template slot-scope="scope">
          <el-button v-permission="['/dept/update']" type="primary" size="mini" @click="edit(scope.row)">{{ $t('button.edit') }}</el-button>
          <el-button v-permission="['/dept/delete']" type="danger" size="mini" @click="remove(scope.row)">{{ $t('button.delete') }}</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-dialog
